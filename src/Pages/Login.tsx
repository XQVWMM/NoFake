...
import { InputWithLabel, InputWithLabelPass } from "../components/InputWithLabel";
    ...
    <div className="flex items-center justify-center min-h-screen bg-white">
      ...
      {isMobile ? (
        <div className="flex flex-col  bg-[#ffff] w-full h-screen text-[#172A3A] ">
          <img src={arrow} alt="" className="w-[35px] h-[35px] p-[10px]"/>
          ...
          <div className="w-[80%] justify-center mt-[50px]">
            ...
            <p className="text-sm text-center mt-4">
              Belum punya akun?{" "}
              <a href="#" className="underline text-[#172A3A] hover:text-gray-200">
                Daftar
              </a>
            </p>
            </div>
        ...
        // Jika desktop
        <div className="bg-[#315D63] w-[582px] h-[723px] rounded-[10px] shadow-xl px-10 py-8 text-[#ffffff]">
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col items-center space-y-4">
            ...
            <div className="w-[85%] flex justify-center mt-[50px]">
              <button
                type="submit"
            ...
            <p className="text-center text-sm text-[#ffff] mt-3">
              Belum punya akun?{" "}
              <a href="#" className="underline text-[#ffff] hover:text-gray-200">
                Daftar
              </a>
            </p>
          </form>
